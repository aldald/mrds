...
(function() {
    ...
    class MRDSReservationForm {
        constructor() {
            ...
            this.restaurantId = this.form.querySelector('input[name="restaurant_id"]')?.value;
        ...
        async loadAvailableHours(dateObj) {
            ...
            try {
                ...
                if (result.success && result.data.periods) {
                    ...
                    const timeSlots = {
                        'Matin': ['08:00', '08:15', '08:30', '08:45', '09:00', '09:15', '09:30', '09:45', '10:00', '10:15', '10:30', '10:45', '11:00', '11:15', '11:30', '11:45'],
                        'Midi':  ['12:00', '12:15', '12:30', '12:45', '13:00', '13:15', '13:30', '13:45', '14:00', '14:15', '14:30', '14:45'],
                        'Soir':  ['19:00', '19:15', '19:30', '19:45', '20:00', '20:15', '20:30', '20:45', '21:00', '21:15', '21:30', '21:45', '22:00', '22:15', '22:30', '22:45']
                    };
                    ...
                    if (hasSlots) {
                        ...
                        if (urlHeure) {
                            ...
                            // Verrouiller le select heure : disabled + hidden input pour la soumission
                            this.timeSelect.disabled = true;
                            let hiddenTime = document.getElementById('resa-time-hidden');
                            if (!hiddenTime) {
                                hiddenTime = document.createElement('input');
                                hiddenTime.type = 'hidden';
                                hiddenTime.id = 'resa-time-hidden';
                                hiddenTime.name = 'time';
                                this.timeSelect.parentNode.appendChild(hiddenTime);
                            }
                            hiddenTime.value = urlHeure;
                        }
                    } else {
                        this.timeSelect.innerHTML = '<option value="">Restaurant fermé ce jour</option>';
                    }
                ...
                this.timeSelect.innerHTML = '<option value="">Erreur de chargement</option>';
            }
        }
        ...
        updateRecap() {
            ...
            if (this.recapGuests) this.recapGuests.textContent = guests + ' personne' + (guests > 1 ? 's' : '');
            ...
            if (this.recapReduction || headerReduction) {
                if (!this.dateKnown) {
                    ...
                    if (this.recapReductionItem) this.recapReductionItem.style.display = 'none';
                } else {
                    if (this.recapReductionItem) this.recapReductionItem.style.display = '';
                    ...
                    if (this.hasReduction && this.reductionText) {
                        ...
                        if (this.recapReductionItem) this.recapReductionItem.classList.remove('recap-no-reduction');
                        // Badge en-tête
                        if (headerReduction) {
                            headerReduction.textContent = this.reductionText + ' de réduction';
                        ...
                        if (this.recapReductionItem) this.recapReductionItem.classList.add('recap-no-reduction');
                        // Badge en-tête
                        if (headerReduction) {
        ...
        initFormValidation() {
            ...
            this.form.addEventListener('submit', function(e) {
                ...
                if (self.submitBtn) {
                    ...
                    self.submitBtn.innerHTML = '<span class="btn-diamond">◆</span> Envoi en cours... <span class="btn-diamond">◆</span>';
                }
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', () => new MRDSReservationForm());
    } else {
